...
protocol XXrayCoreManagerProtocol {
...
//    private class XrayCoreManagerCallbackHandler: NSObject, XraycoregoXrayCoreCallbackHandlerProtocol {
...
//    private var controller: XraycoregoXrayCoreController? = nil
//    private var startCompletion: ((NEVPNError?) -> ())? = nil
//    
//    init(callbackHandler handler: XrayCoreManagerProtocol? = nil) {
//        callbackHandler = handler
//        xcCallbackHandler = XrayCoreManagerCallbackHandler()
//        controller = XraycoregoNewXrayCoreController(xcCallbackHandler)
//    }
//      
...
//    }
//    
//    func start(config: String, assets: URL, completion: @escaping (NEVPNError?) -> ()) {
...
//        }
//
//        XraycoregoInitXrayCoreEnv(assets.path)
//        
...
//    }
//    
//    func start(config: String, assets: URL) async -> Result<Void, NEVPNError> {
